...
public class LC872LeafSimilarTrees {
    ...
    class Solution {
        public boolean leafSimilar(TreeNode root1, TreeNode root2) {
            String root1Str = toLeafStr(root1, "");
            String root2Str = toLeafStr(root2, "");
            return root1Str.equals(root2Str);
        }

        public String toLeafStr(TreeNode root, String results) {
            if (root == null) return results;
            if (root.left == null && root.right == null) return results + "," + root.val;
            return toLeafStr(root.left, results) + toLeafStr(root.right, results);
        }
    }
